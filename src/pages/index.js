...
const IndexPage = () => (
  <div>
    ...
    <p>See, here is the home of a special kind of bird. Not only one that knows how to develop web applications using JAM Stack, Progressive Web Apps, Service Workers etc.,
    ...
    <p>Then let me start by <Link to="/about/">introducing myself.</Link></p>
    <p>Interested in the tools and skills I use in development? <Link to="/dev-stack/">Might as well go here.</Link></p>
    <p>Is it the UX process that have picked your interest? Then, <Link to="/ux-design/">head right there!</Link></p>
  </div>
)
